export const HOTSPOT_CARDS = [
  {
    ...
    news_summary:
      "多家媒体集中讨论国产视频生成模型 Seedance 2.0 的逼真度与稳定性提升，引发创作者与营销圈对‘视频内容生产范式改变’的关注。重点不再是单条作品质量，而是能否支撑更低成本、更快迭代的规模化视频生产。",
    news_bullets: [
  ...
  },
  {
    ...
    news_summary:
      "媒体复盘春节周期的AI产品竞争，焦点从短期拉新转向长期留存：谁能把AI从聊天工具升级为可执行的任务链，谁更可能稳定留住用户与场景。",
    news_bullets: [
      "拉新手段趋同：投放/红包/联动",
      "留存取决于任务完成：从问答到流程化执行",
      "场景深度更重要：把AI嵌到具体业务里"
  ...
  },
  {
    ...
    news_summary:
      "机构与媒体讨论春节前后AI产品的营销投入、用户增长与MAU体量变化，行业对‘规模化运营与持续迭代’的预期增强。",
    news_bullets: [
      "规模化投放与增长成为常态",
      "用户心智教育加速：AI被当作基础设施",
      "企业侧更看重可解释的效果与稳定交付"
  ...
  },
  {
    ...
    news_summary:
      "媒体以数据视角讨论国内大模型的调用与应用渗透趋势，意味着AI正在成为基础设施，企业更关注落地效果与业务链路。",
    news_bullets: [
      "模型能力趋同，差异转向场景与链路",
      "企业侧更在意：可控、可交付、可复盘",
  ...
  },
  {
    ...
    news_summary:
      "围绕开源模型与算力适配的讨论持续，推动更多企业考虑本地部署、成本可控与数据资产安全。",
    news_bullets: [
      "本地部署/私有化需求上升",
      "成本与稳定性变重要：算力、延迟、可维护",
  ...
  },
  {
    ...
    news_summary:
      "报道提到千问布局AI眼镜等硬件形态，意味着AI能力更可能嵌入线下与随身场景，端侧入口强化。",
    news_bullets: [
      "端侧入口增加：更即时、更场景化",
      "线下体验可被内容化：可拍、可讲、可转化",
  ...
  },
  {
    ...
    news_summary:
      "权威媒体集中讨论具身智能与人形机器人热度，强调从技术到应用的加速。对品牌而言，可内容化的将是‘智能体验过程’。",
    news_bullets: [
      "从屏幕AI走向物理世界服务",
      "体验过程可视化：更适合短视频传播",
...
export const ACTION_SUGGESTIONS = {
  Growth: [
    "本周内产出1份《行业场景任务链蓝图》PPT（含3条客户路径）",
    "搭建1个‘内容到转化’最小流程Demo（含数据回流字段）",
    "完成1次客户访谈纪要与机会清单（>=8条）"
  ],
  GEO: [
    "整理1份《小红书问题词库》CSV（>=80词，标注入口类型）",
    "输出1套《GEO结构化写法模板》文档（含示例3篇）",
    "制作1个引用率复盘表Excel（含字段与示例数据）"
  ],
  Ads: [
    "建立1个投流素材ID管理表（含脚本/镜头/卖点字段）",
    "产出1套‘前三秒钩子’脚本模板（>=10条）",
    "完成1轮投放AB实验复盘（含CTR/ROI结论）"
  ],
  Deploy: [
    "输出1份行业交付清单（含交付物/周期/验收口径）",
    "搭建1个可配置内容模板库（>=20模板）",
    "制作1张交付流程泳道图（含职责分工）"
  ]
};
