export const HOTSPOT_CARDS = [
  {
    ...
    news_overview:
      "Seedance 2.0 的讨论焦点从“逼真度”转向“可量产性”，意味着视频生成开始被营销团队当作规模化生产能力。",
    news_detail:
      "围绕 Seedance 2.0 的讨论从“逼真度”转向“可量产性”：更稳定的角色/场景一致性与镜头运动控制，让营销团队开始把视频生成当作可规模化的生产能力而非单次展示。由此引发的问题不再是“能不能做出好看视频”，而是“能否持续低成本、高效率地生成可投放素材并形成迭代机制”。这意味着内容生产链路将被重新拆分为脚本模板化、镜头组件化、投放数据回流三段，最终进入“可复盘的素材工厂”模式。",
    news_bullets: [
  ...
  },
  {
    ...
    news_overview:
      "春节AI产品竞争的复盘显示，长期留存关键不是红包与投放，而是把AI变成可执行的任务链。",
    news_detail:
      "春节周期的AI产品竞争被复盘为“入口争夺战”，但讨论点正在从短期拉新转向长期留存。媒体与行业评论认为，红包、投放等拉新方式趋同后，真正拉开差距的将是“可执行的任务链”——把AI从聊天工具升级为能完成具体业务流程的系统，才有机会稳定留住用户与场景。对企业侧来说，入口只是触点，决定复购的是能否完成真实的业务任务，尤其是“从内容到转化”的闭环效率。",
    news_bullets: [
      "拉新手段趋同：投放/红包/联动",
      "留存取决于任务完成：从问答到流程化执行",
      "场景深度更重要：把AI嵌到具体业务里"
  ...
  },
  {
    ...
    news_overview:
      "春节档AI营销的投入与MAU讨论推动客户预期升级，更看重稳态增长和可解释效果。",
    news_detail:
      "春节档的AI应用投放与用户增长数据引发行业讨论，机构观点强调：AI产品已从“尝鲜型玩法”转向“基础设施心智”，客户对效果的预期被规模化指标拉高。对于企业客户而言，更在意的是可解释的转化链路与稳定交付能力，而不是一次性的流量爆发。长期来看，营销团队需要用“持续可复盘的增长系统”替代“短期爆点投放”，并把内容资产与投放数据联动成可迁移的方法论。",
    news_bullets: [
      "规模化投放与增长成为常态",
      "用户心智教育加速：AI被当作基础设施",
      "企业侧更看重可解释的效果与稳定交付"
  ...
  },
  {
    ...
    news_overview:
      "当模型能力趋同后，竞争转向“应用渗透率”和业务链路效果，场景与可交付成为核心。",
    news_detail:
      "多份报告与盘点显示，大模型能力的差异正在收敛，调用量与应用渗透率成为衡量竞争力的重要指标。企业更关心“AI是否真正进入业务链路”，而不是模型参数的细微差别。平台生态（内容/搜索/电商）被视为关键战场：谁能把AI嵌入可交付的业务流程，谁就更可能获得长期价值。这一趋势也倒逼营销团队把“内容与转化”拆成可复用的流程模板。",
    news_bullets: [
      "模型能力趋同，差异转向场景与链路",
      "企业侧更在意：可控、可交付、可复盘",
  ...
  },
  {
    ...
    news_overview:
      "开源与算力适配的讨论推动企业转向本地化与私有化交付，强调成本与资产可控。",
    news_detail:
      "围绕开源模型与算力适配的讨论持续，越来越多企业将关注点转向本地部署与私有化交付。核心诉求不只是“能用模型”，而是“成本可控、数据可控、资产可接入”。行业方案与交付能力成为竞争壁垒：谁能把知识库/素材库接入并形成可维护的流程，谁就更有机会拿下高客单客户。对于营销业务来说，交付能力正在从“模型接入”转向“内容与分发的闭环落地”。",
    news_bullets: [
      "本地部署/私有化需求上升",
      "成本与稳定性变重要：算力、延迟、可维护",
  ...
  },
  {
    ...
    news_overview:
      "AI眼镜等端侧入口加速，内容营销从“线上广告”向“线下场景导购”转变。",
    news_detail:
      "千问在AI眼镜等硬件形态上的布局被解读为“端侧入口的加速”：AI能力更可能嵌入线下与随身场景，内容营销也因此从“线上广告”逐步转向“场景导购”。在端侧入口里，用户更关注即时解答、现场体验与可转化的导购路径，内容形式也更强调可拍、可讲、可追踪。营销团队需要把线下体验拆成脚本与场景词，并用扫码与导购链路连接到转化。",
    news_bullets: [
      "端侧入口增加：更即时、更场景化",
      "线下体验可被内容化：可拍、可讲、可转化",
  ...
  },
  {
    ...
    news_overview:
      "具身智能热度推动品牌叙事转向“体验过程”，内容化对象从参数转为服务流程。",
    news_detail:
      "权威媒体集中讨论具身智能与人形机器人热度，强调从技术展示走向应用落地的加速。对品牌而言，最容易内容化的部分是“服务过程与体验场景”，而不是技术参数。体验过程可视化更适合短视频传播，也更容易形成可复制的叙事模板，这使“服务流程内容化”成为新的竞争点。对内容营销团队来说，关键在于把流程拍成脚本并形成可规模化的素材矩阵。",
    news_bullets: [
      "从屏幕AI走向物理世界服务",
      "体验过程可视化：更适合短视频传播",
  ...
  },
  {
    ...
    news_overview:
      "小红书GEO本质是争夺AI总结引用席位，首要目标不是爆款而是被引用。",
    news_detail:
      "（行业观察口径）小红书GEO被视作“AI总结引用席位争夺”：引用位有限，意味着策略首要目标不是爆款，而是被引用。不同入口触发机制存在差异：点点更易触发上下文联想，问一问展示位受限，直搜产品词触发率低但叠加痛点疑问/对比抉择更容易撕口子。对内容营销来说，结构化写作与评论语料工程正在成为新的“占位能力”，需要用问题词库+结构化笔记+评论高赞语料来形成引用率闭环。",
    news_bullets: [
